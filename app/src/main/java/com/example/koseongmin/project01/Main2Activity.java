...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginId = loginIntent.getStringExtra("id");
        loginPassword = loginIntent.getStringExtra("password");
        ...
        */
            ...
            navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    if(id==R.id.nav_edit){    //회원정보수정
                        Intent modifyIntent = new Intent(Main2Activity.this, ModifyActivity.class);
                        modifyIntent.putExtra("id", loginId);
                        modifyIntent.putExtra("password", loginPassword);
                        ...
                        Intent family=new Intent(Main2Activity.this,FamilyActivity.class);
                        family.putExtra("id", loginId);
                        startActivity(family);
                    }else if(id==R.id.nav_shopping1){
                        Intent shoppingIntent = new Intent(Main2Activity.this, ShoppingActivity.class);
                        startActivity(shoppingIntent);
                    }else if(id==R.id.nav_shopping2){
                        Intent shoppingIntent = new Intent(Main2Activity.this, ShoppingActivity2.class);
                        startActivity(shoppingIntent);
                    }else if(id==R.id.nav_shopping3){
                        Intent shoppingIntent = new Intent(Main2Activity.this, ShoppingActivity3.class);
                        startActivity(shoppingIntent);
                    }else if(id==R.id.kbs){
                        Intent kbsIntent = new Intent(Main2Activity.this, NewsActivity.class);
                        startActivity(kbsIntent);
                    }else if(id==R.id.sbs){
                        Intent sbsIntent = new Intent(Main2Activity.this, NewsActivity2.class);
                        startActivity(sbsIntent);
                    }else if(id==R.id.mbc){
                        Intent mbcIntent = new Intent(Main2Activity.this, NewsActivity3.class);
                        startActivity(mbcIntent);
                    }else if(id==R.id.jtbc){
                        Intent jtbcIntent = new Intent(Main2Activity.this, NewsActivity4.class);
